package CH05_Liveness.Deadlock;
...
//        new Philosopher("Steve", chopstickC, chopstickA).start(); //this will cause a deadlock.
        new Philosopher("Steve", chopstickA, chopstickC).start(); //change the order will fix it
    }
}